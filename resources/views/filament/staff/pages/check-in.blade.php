<x-filament-panels::page>
    <div>
            ...
            >
                <x-filament::section>
                    ...
                    <x-slot name="headerEnd">
                        <x-filament::button type="button" @click="$dispatch('open-modal', { id: 'manual-search' })">
                            Cari Manual
                        </x-filament::button>
                    </x-slot>
        ...
        <x-filament::modal id="manual-search" width="3xl">
            <div>
                <form wire:submit="manualSearch">
                    {{ $this->manualSearchForm }}
                </form>
            </div>
        </x-filament::modal>
    </div>
